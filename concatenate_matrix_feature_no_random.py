		...
		if l_A == l_A_1 and l_A == l_A_2 and ratio_A>0.05:
			if l_B == l_B_1 and l_B == l_B_2 and ratio_B>0.05:
				if l_C == l_C_1 and l_C == l_C_2 and ratio_C>0.05:
					...
					feature_A_B_name=os.path.join('./2_chain_feature_no_random/',pdb_name+'_'+chain_A+'_'+chain_B+'.jpg')
...
#					random_A_C=np.random.random((l_A,l_C))
					random_A_C=np.zeros((l_A,l_C))
			                ...
			                feature_A_C_name=os.path.join('./2_chain_feature_no_random/',pdb_name+'_'+chain_A+'_'+chain_C+'.jpg')
...
#					random_B_C=np.random.random((l_B,l_C))
					random_B_C=np.zeros((l_B,l_C))
			                ...
			                feature_B_C_name=os.path.join('./2_chain_feature_no_random/',pdb_name+'_'+chain_B+'_'+chain_C+'.jpg')
