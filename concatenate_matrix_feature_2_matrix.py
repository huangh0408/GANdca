...
#					imsave(feature_A_B_name,feature_A_B)
					flag_A_B_name=os.path.join('./2_chain_flag_matrix/',pdb_name+'_'+chain_A+'_'+chain_B+'.txt')
			                np.savetxt(flag_A_B_name,flag_A_B)
...
#			                feature_A_C_name=os.path.join('./2_chain_feature/',pdb_name+'_'+chain_A+'_'+chain_C+'.txt')
#			                imsave(feature_A_C_name,feature_A_C)
			                flag_A_C_name=os.path.join('./2_chain_flag_matrix/',pdb_name+'_'+chain_A+'_'+chain_C+'.txt')
			                np.savetxt(flag_A_C_name,flag_A_C)		
...
#			                imsave(feature_B_C_name,feature_B_C)
			                flag_B_C_name=os.path.join('./2_chain_flag_matrix/',pdb_name+'_'+chain_B+'_'+chain_C+'.txt')
			                np.savetxt(flag_B_C_name,flag_B_C)
#	temp=args.split('.')
 #       tmp=temp[0]
