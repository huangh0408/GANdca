...
ccmpred_acc=[]
j=0
output_dir='./hh_2_23/images/'
for filename in os.listdir('./workspace_2_23/cm_DeepCov_flag/val'):
	temp=filename.split('.')
	name=temp[0]
	...
	DeepCov_matrix_name=os.path.join('/home/huanghe/huangh/inter_protein_contact_prediction_data_prepare/dc_train/DeepCov_part_matrix',name+'.matrix')
#	psicov_matrix_name=os.path.join('./feature_2_21/feature_contact_matrix/psicov',name+'.matrix')
	contact_matrix_name=os.path.join('/home/huanghe/huangh/inter_protein_contact_prediction_data_prepare/dc_train/flag_matrix',name+'.matrix')
