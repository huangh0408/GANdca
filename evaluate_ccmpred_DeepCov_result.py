...
DeepCov_acc=[]
j=0
for filename in os.listdir('./com_ccmpred_DeepCov_flag/val'):
	temp=filename.split('.')
	name=temp[0]
	...
	predict_matrix_file=os.path.join('./hh_1_12_2/images/',name+'-outputs.png')
#	ccmpred_matrix=os.path.join('./TEST.1.7/images/',name+'-inputs.png')
	contact_matrix_file=os.path.join('./hh_1_12_2/images/',name+'-targets.png')
