...
ccmpred_acc=[]
j=0
output_dir='./hh_2_21_2/images/'
for filename in os.listdir('./workspace_2_21/cm_DeepCov_flag/val'):
	temp=filename.split('.')
	name=temp[0]
	fasta_file=os.path.join('./feature_2_21/feature_contact_matrix/ccmpred',name+'.ccmpred')
	...
	contact_matrix_name=os.path.join('./flag_2_21/flag_contact_matrix',name+'.matrix')
